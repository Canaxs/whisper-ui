            ...
            <div className="w-[98%] ml-[1%]">
                ...
                <div className="w-3/4 ml-[12.5%] mt-6 mb-6 flex justify-between items-center">
                    <div className="flex flex-wrap">
                        <span id="popular" onClick={() => chooseClick("popular")} className={writeCategory == "popular" ? "bg-gray-200 drop-shadow text-2xl max-lg:text-xl max-md:text-base border border-gray-200 max-sm:text-sm shadow-md max-md:p-2 p-3 m-1 rounded-md cursor-pointer hover:shadow-xl hover:bg-gray-100 transition-all" : "drop-shadow text-2xl max-lg:text-xl max-md:text-base border border-gray-200 max-sm:text-sm shadow-md max-md:p-2 p-3 cursor-pointer hover:shadow-xl hover:bg-gray-100 transition-all m-1 rounded-md"}>Popüler Yazarlar</span>
                        <span id="month" onClick={() => chooseClick("month")} className={writeCategory == "month" ? "bg-gray-200 drop-shadow text-2xl max-lg:text-xl max-md:text-base border border-gray-200 max-sm:text-sm shadow-md max-md:p-2 p-3 m-1 rounded-md cursor-pointer hover:shadow-xl hover:bg-gray-100 transition-all" : "drop-shadow text-2xl max-lg:text-xl max-md:text-base border border-gray-200 max-sm:text-sm shadow-md max-md:p-2 p-3 cursor-pointer hover:shadow-xl hover:bg-gray-100 transition-al m-1 rounded-md"}>Ayın Yazarları</span>
                        <span id="week" onClick={() => chooseClick("week")} className={writeCategory == "week" ? "bg-gray-200 drop-shadow text-2xl max-lg:text-xl max-md:text-base border border-gray-200 max-sm:text-sm shadow-md max-md:p-2 p-3 m-1 rounded-md cursor-pointer hover:shadow-xl hover:bg-gray-100 transition-all" : "drop-shadow text-2xl max-lg:text-xl max-md:text-base border border-gray-200 max-sm:text-sm shadow-md max-md:p-2 p-3 cursor-pointer hover:shadow-xl hover:bg-gray-100 transition-all m-1 rounded-md"}>Haftanın Yazarları</span>
                    </div>
                    <div>
