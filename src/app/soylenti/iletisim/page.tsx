            ...
            <div className="mt-10 ml-2">
              ...
              <div className="mt-10 flex justify-between max-lg:flex-col">
                <div className="text-lg w-[50%] max-lg:w-full max-lg:text-center">
                  ...
                  <p>
                    <span className="font-medium text-gray-700 drop-shadow">
                      Adres :
                    </span>{" "}
                    İzmir Konak
                  </p>
                  ...
                  <ul className="flex text-lg mt-5 justify-center">
                    ...
                    <li className="p-3 cursor-pointer">
                      <a href="https://x.com/soylentisite">
                ...
                <div className="h-[500px] w-[50%] max-lg:w-full max-lg:h-[300px]">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d827.9091822049071!2d27.142688881415467!3d38.42370713014896!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1str!2str!4v1722700095502!5m2!1str!2str"
                    width="98%"
                    height="100%"
                    style={{ border: "0" }}
                    loading="lazy"
