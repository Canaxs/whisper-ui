...
import { getWhisper } from "@/api/apiCalls";
                        ...
                        <CardContent className="p-3">
                            <div className="flex">
                                ...
                                <div className="flex flex-col pt-7 pl-7">
                                    <span className="text-gray-400 text-xs font-medium">Kategori</span>
                                    <span className="text-3xl mt-2 font-medium">Lorem İpsum Sit Amet Lorem İpsum Sit Amet</span>
                                    <div className="p-0 mt-3 mb-3 ml-0">
                                        <HovCard name={"Söylenti"} />
                                    </div>
                                </div>
                            </div>
                        </CardContent>
