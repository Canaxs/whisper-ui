...
export function UserPendingTable2() {
    ...
    const [selectWhisper, setSelectWhisper] = useState({ id: 0 , username: "" , userPoint: "" })
        ...
        <div> 
                    ...
                    {selectData.map((obj,index) => (
                        <div>
                            <div className="flex justify-between cursor-pointer hover:bg-gray-300 transition-all shadow-md" onDoubleClick={() => openPopup(obj)}>
                                ...
                                <span className="p-3 w-[22%] text-center">Kullanıcı</span>
            ...
            <DialogContent>
                    ...
                    <DialogDescription>
                      <div>
                        <div>
                            <span>Id:</span> {selectWhisper.id}
                        </div>
                        <div className="mt-2">
                            <span>Kullanıcı Adı :</span> {selectWhisper.username}
                        </div>
                        <div className="mt-2">
                          <span>Puan :</span> {selectWhisper.userPoint}
                        </div>
                      </div>
                    </DialogDescription>
                    <DialogFooter>
                      <div>
                        <Button className="mr-2 bg-green-500 hover:bg-white  border hover:text-green-500 transition-all">Yetki Yükselt</Button>
