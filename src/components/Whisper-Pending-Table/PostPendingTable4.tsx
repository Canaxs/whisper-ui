import { getWhispers, updateIsDelete } from "@/api/apiCalls";
...
export function PostPendingTable4() {
    ...
    return (
        <div> 
            <h1 className="font-medium drop-shadow-sm">Tüm Paylaşımlar</h1>
