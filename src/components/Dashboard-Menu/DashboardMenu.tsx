...
export default function DashboardMenu(props) {
    return (
        <div className="w-[300px] h-full bg-gradient-to-br from-zinc-50 to-zinc-50 rounded p-3">
            ...
            <Label className="pl-3"><span className="font-medium">Deneme</span>, Hoşgeldiniz</Label>
            <Label className="text-xs pl-3 mt-1"><span className="">Yetki Seviyesi : </span> Admin</Label>
            </div>
            <ul className="mt-5">
