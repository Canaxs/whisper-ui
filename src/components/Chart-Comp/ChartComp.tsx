            ...
            <CardHeader className="flex flex-col items-stretch space-y-0 border-b p-0 sm:flex-row">
                ...
                {["desktop", "mobile"].map((key) => {
                    ...
                    <button key={chart} data-active={activeChart === chart} className="relative z-30 flex flex-1 flex-col justify-center gap-1 border-t px-6 py-4 text-left even:border-l data-[active=true]:bg-muted/50 sm:border-l sm:border-t-0 sm:px-8 sm:py-6"
                        ...
                        <span className="text-lg font-bold leading-none sm:text-2xl"> {total[key as keyof typeof total].toLocaleString()} </span>
                    </button>
                    )
                })}
                </div>
            ...
            <CardContent className="px-2 sm:p-6">
                ...
                <BarChart accessibilityLayer data={chartData} margin={{ left: 12, right: 12,}}>
                    ...
                    <ChartTooltip content={ <ChartTooltipContent
                        className="w-[150px]"
                        nameKey="views"
                        labelFormatter={(value) => { return new Date(value).toLocaleDateString("tr-TR", {
                            month: "short",
                            day: "numeric",
                            year: "numeric",
                            })
